  ...
  const featureCards = [
    {
      title: "Upload Resume",
      description:
        "Drag and drop your resume. Our AI analyzes skills, experience, and career potential instantly.",
      icon: Bookmark,
      color: "text-blue-600",
    ...
    },
    {
      title: "AI Analysis",
      description:
        "Get detailed skill assessment, gap analysis, and personalized recommendations for growth.",
      icon: Sparkles,
    ...
    },
    {
      ...
      description:
        "Receive a structured, step-by-step career path tailored to your goals and current skills.",
      icon: Map,
  ...
  const featureGrid = [
    {
      ...
      description:
        "AI-powered analysis of your resume with scoring and improvement suggestions.",
      icon: Bookmark,
    },
    {
      title: "Skill Gap Detection",
      description:
        "Identify missing skills for your target role with priority recommendations.",
      icon: Sparkles,
    },
    {
      title: "Career Paths",
      description:
        "Explore multiple career tracks: Frontend, Backend, AI Engineer, and more.",
      icon: Map,
    },
    {
      title: "Roadmap Generator",
      description:
        "Get a structured roadmap from beginner to job-ready with timelines.",
      icon: TrendingUp,
    },
    {
      title: "AI Mentor Chat",
      description:
        "Chat with your AI mentor for real-time guidance and career advice.",
      icon: MessageCircle,
    },
    {
      title: "Progress Tracking",
      description:
        "Monitor your learning progress and skill development journey.",
      icon: Zap,
    },
  ];
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="text-sm font-black uppercase tracking-widest px-4 py-2 hover:text-blue-600 transition-colors"
            >
              Sign In
            </button>
            <button
      ...
      <main className="mx-auto max-w-7xl px-6">
        <section className="relative pt-20 pb-16 text-center lg:pt-32">
          ...
          <p className="mx-auto mt-8 max-w-2xl text-lg leading-relaxed text-slate-500 dark:text-slate-400 font-medium">
            The all-in-one platform to upload your resume, detect skill gaps,
            and generate hyper-personalized career roadmaps powered by Gemini.
          </p>
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {featureCards.map((item) => {
              ...
              return (
                <div
                  key={item.title}
                  className="group relative rounded-[2.5rem] border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 p-10 shadow-sm transition-all hover:-translate-y-2 hover:shadow-2xl"
                >
                  <div
                    className={`mb-8 inline-flex h-16 w-16 items-center justify-center rounded-3xl ${item.bg} ${item.color} transition-transform group-hover:rotate-6`}
                  >
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {valueProps.map((prop) => {
              ...
              return (
                <div
                  key={prop.title}
                  className="p-8 rounded-[2rem] border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 shadow-sm"
                >
                  <div
                    className={`w-12 h-12 ${prop.color} rounded-xl flex items-center justify-center text-white mb-6 shadow-lg`}
                  >
                    <Icon size={24} />
                  </div>
          ...
          <div className="relative z-10 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {featureGrid.map((item) => {
              ...
              return (
                <div
                  key={item.title}
                  className="rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm transition-all hover:bg-white/10"
                >
        ...
        <section className="mt-32 relative group overflow-hidden rounded-[3rem] bg-gradient-to-br from-blue-600 to-indigo-700 p-12 md:p-20 text-center text-white shadow-2xl">
          ...
          <p className="relative z-10 text-xs font-black uppercase tracking-[0.4em] text-blue-100">
            Future Ready
          </p>
      ...
      <footer className="mt-32 border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-[#020617] py-20">
        <div className="mx-auto flex flex-col md:flex-row justify-between items-center gap-8 px-6">
          ...
          <p className="text-xs font-black uppercase tracking-widest text-slate-400">
            © 2026 AI Career Consultant
          </p>
          <div className="flex gap-8 text-xs font-black uppercase tracking-widest text-slate-400">
            <a
              href="https://github.com/kuldeep-singh-pro/ai-career-consultant"
              target="_blank"
