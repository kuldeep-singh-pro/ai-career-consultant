...
}> = ({ children }) =>
{
  ...
  return (
    <div className="flex h-screen bg-slate-50 dark:bg-slate-900 transition-colors">
      ...
      >
        <header className="bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 px-6 py-4 flex justify-between items-center transition-colors">
